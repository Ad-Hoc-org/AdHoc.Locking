...
public readonly struct ZooKeeperContext
{
    ...
    public Func<IEnumerable<ZooKeeperPath>, Types, WatchAsync, IZooKeeperWatcher> RegisterWatcher { get; }
    ...
    public ZooKeeperContext(
        ...
        Func<IEnumerable<ZooKeeperPath>, Types, WatchAsync, IZooKeeperWatcher> registerWatcher)
    {
        Root = root;
        Writer = writer;
