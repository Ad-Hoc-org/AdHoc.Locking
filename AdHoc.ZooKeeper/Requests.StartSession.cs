...
public static partial class Requests
{
    ...
    public const int StartSessionSize = LengthSize + ProtocolVersionSize + ServerConnectionSize + TimeoutSize + SessionSize + LengthSize + ReadOnlySize;
    ...
    public static void CreateStartSession(Span<byte> buffer, int timeout, bool readOnly)
    {
        ...
        // 12, 4 last zxid
        buffer.Slice(LengthSize, ClientConnectionSize + SessionSize).Clear();
        // 16, 4 timeout
